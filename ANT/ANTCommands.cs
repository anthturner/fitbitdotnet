...
{
    internal static class ANTCommands
    {
        internal static byte ANTChannel = 0x00;
        ...
        {
            return ANTWrapped(new byte[] { 0x45, ANTChannel, frequency });
        }
        ...
        {
            return ANTWrapped(new byte[] { 0x44, ANTChannel, timeout });
        }
        ...
        internal static byte[] Reset4F()
        {
            ...
            return ANTWrapped(new byte[] { 0x4F, ANTChannel, 0x78, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 });
        }

        internal static byte[] DeviceIDReset4F(byte[] channel)
        {
            return ANTWrapped(new byte[] { 0x4F, ANTChannel, 0x78, 0x02, channel[0], channel[1], 0x00, 0x00, 0x00, 0x00 });
        }
        ...
        {
            return ANTWrapped(new byte[] { 0x4b, ANTChannel });
        }

        internal static byte[] CloseChannel()
        {
            return ANTWrapped(new byte[] { 0x4c, ANTChannel });
        }

        internal static byte[] AssignChannel()
        {
            return ANTWrapped(new byte[] { 0x42, ANTChannel, 0x00, 0x00 });
        }
